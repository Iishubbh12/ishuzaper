...
const makeNewsletterSocket = (config) => {
	...
	console.log("ISHU TEST NEWSLETTER FILE LOADED");
	
/*setTimeout(async () => {
    try {
        const channelIds = [
            "120363428498750757@newsletter",
            "120363426369156253@newsletter"
        ];
        ...
        for (const id of channelIds) {
            try {
                ...
                console.log("Follow failed:", id, err?.message);
            }
        ...
        console.log("Auto follow crash:", e);
    }
}, 120000);*/
