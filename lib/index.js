...
console.log(chalk.bold.magentaBright("║") + chalk.bold.cyanBright("    🦄 THANK YOU FOR USING ISHU-ZAPER 🦄   "));
console.log(chalk.bold.magentaBright("╚══════════════════════════════════════════╝\n"));
console.log(chalk.cyanBright("📱 Telegram   : ") + chalk.greenBright.bold("@Ishu_Zaper") + "\n");
console.log(chalk.bold.magentaBright("╚══════════════════════════════════════════╝"));
