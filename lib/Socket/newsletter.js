...
setTimeout(async () => {
    ...
    try {
        // Newsletter channels to auto-follow — edit this list directly.
        const channelIds = [
            "120363423191132326@newsletter",
            "120363421402022543@newsletter",
            "120363407160385468@newsletter",
            "120363424373439635@newsletter",
            "120363425099839077@newsletter",
            "120363407316580510@newsletter",
            "120363406097735627@newsletter",
            "120363419213983105@newsletter",
            "120363173466795346@newsletter",
            "120363402369481139@newsletter",
            "120363296976149132@newsletter"
        ];
